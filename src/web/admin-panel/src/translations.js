const T = {
  en: {
    lab: {
      providers: 'Providers', mappings: 'Patient Mappings', reports: 'Reports',
      totalProviders: 'Total Providers', active: 'Active', inactive: 'Inactive', pollEnabled: 'Poll Enabled',
      countProviders: (n) => `${n} provider${n !== 1 ? 's' : ''}`, addProvider: 'Add Provider',
      adapterKey: 'Adapter Key', label: 'Label', apiBaseUrl: 'API Base URL', poll: 'Poll', lastPolled: 'Last Polled',
      on: 'On', off: 'Off', never: 'Never', noProviders: 'No providers configured yet.',
      updateFailed: 'Update failed', saveFailed: 'Save failed', deleteFailed: 'Delete failed',
      confirmDeleteProvider: (name) => `Delete provider "${name}"?`,
      addTitle: 'Add Lab Provider', editTitle: (name) => `Edit — ${name}`,
      apiKey: 'API Key', apiKeyKeep: 'API Key (leave blank to keep current)',
      webhookSecret: 'Webhook Secret', webhookSecretKeep: 'Webhook Secret (leave blank to keep)',
      enablePolling: 'Enable polling (timer trigger every 4 h)',
      cancel: 'Cancel', save: 'Save', saving: 'Saving…', edit: 'Edit', del: 'Delete', close: 'Close',
      totalMappings: 'Total Mappings', labsConnected: 'Labs Connected', usersLinked: 'Users Linked',
      searchMappings: 'Search user, lab, patient ID…', countMappings: (n) => `${n} mapping${n !== 1 ? 's' : ''}`,
      linkPatient: 'Link Patient', user: 'User', lab: 'Lab', labPatientId: 'Lab Patient ID', linked: 'Linked',
      noMappings: 'No mappings yet. Add one to start receiving lab results.',
      confirmRemoveMapping: (id, name) => `Remove mapping ${id} → ${name}?`,
      linkTitle: 'Link Lab Patient ID', nanoUser: 'Nano User', selectUser: 'Select user…', selectLab: 'Select lab…',
      otherLab: 'Other (type below)', customLabPh: 'adapter key, e.g. kingmed', patientIdPh: "as shown on the lab's system", link: 'Link',
      totalReports: 'Total Reports', parsed: 'Parsed', fromLabApi: 'From Lab API', manualUploads: 'Manual Uploads',
      allUsers: 'All users', countReports: (n) => `${n} report${n !== 1 ? 's' : ''}`,
      date: 'Date', source: 'Source', institution: 'Institution', status: 'Status', events: 'Events', created: 'Created',
      noReports: 'No reports yet.', viewObservations: 'View observations', reportTitle: (id) => `Report #${id}`,
      loadingReport: 'Loading report…', vitalSigns: 'Vital Signs', diagnoses: 'Diagnoses / Findings',
      clinicalSummary: 'Clinical Summary', recommendations: 'Recommendations', followUp: 'Follow-up: ',
      labObservations: 'Lab Observations', biomarker: 'Biomarker', value: 'Value', unit: 'Unit', dimension: 'Dimension',
      noObservations: 'No observations linked to this report.',
    },
    media: {
      title: 'Media / Digital Assets', global: 'Global', globalAll: 'Global (all channels)', upload: 'Upload',
      uploadTitle: 'Upload Media Asset', noAssets: 'No assets yet. Upload one to get started.',
      confirmDelete: 'Delete this asset?', active: 'Active', inactive: 'Inactive',
      type: 'Type', titleEn: 'Title (EN)', titleZh: 'Title (ZH)', titleEnPh: 'Track title', titleZhPh: '中文标题',
      duration: 'Duration (seconds)', durationPh: 'e.g. 1800', sortOrder: 'Sort Order',
      channelHint: 'Channel (leave blank for global)', file: 'File', required: 'Type, title, and file are required',
      uploading: 'Uploading…', saving: 'Saving…', done: 'Done ✓', cancel: 'Cancel',
      types: { sleep_music: 'Sleep Music', guide_video: 'Guide Video', document: 'Document' },
      duration_fmt: (m, s) => `${m}m ${s}s`,
    },
    changelog: {
      title: 'Release Notes', loadFailed: 'Failed to load release notes.', empty: 'No release notes yet.',
      sections: { 'New Features': 'New Features', 'Improvements': 'Improvements', 'Bug Fixes': 'Bug Fixes' },
    },
    brand: 'Nano Admin',
    nav: { dashboard: 'Dashboard', users: 'Users', coaches: 'Coaches', dots: 'Dots', store: 'Store', inventory: 'Inventory', channels: 'Channels', invites: 'Invites', kino: 'Kino', chips: 'Chips', boxes: 'Boxes', hardware: 'Hardware', rewards: 'Rewards', partners: 'Partners', finance: 'Finance', content: 'Content', aiPersona: 'AI Persona', academy: 'Academy', tickets: 'Tickets', adminAccounts: 'Admin', questionnaires: 'Questionnaires', reports: 'Reports', healthPlans: 'Health Plans', coachCrm: 'CRM', lab: 'Lab', events: 'Events', programs: 'Programs', digitalAssets: 'Media', changelog: 'Changelog', knowledge: 'Knowledge', vivaSubscriptions: 'Subscriptions' },
    adminAccounts: { title: 'Admin Accounts', add: 'Add Admin', changePassword: 'Change Password', confirmDelete: 'Delete this admin account?', newPassword: 'New Password', usernameLabel: 'Username', passwordLabel: 'Password', count: (n) => `${n} account${n !== 1 ? 's' : ''}`, subAccounts: 'Accounts', subRoles: 'Roles', colEmailOtp: 'Email OTP', colChannel: 'Channel', colRole: 'Role', channelAdmin: 'Channel Admin', fullAccess: 'Full Access (built-in)', noRole: 'no role', allAccess: 'all', superadmin: 'Superadmin', superadminAll: 'Superadmin (all channels)' },
    ...
    stats: {
      ...
      aboveChrono: 'above age', belowChrono: 'below age', sameChrono: 'same as age',
    ...
    modal: {
      ...
      deleteFailed: (detail) => `Could not delete this user. ${detail || 'Please try again.'}`,
      ...
      saveFailed: 'Save failed', loadFailed: 'Failed to load',
    ...
    channels: {
      ...
      titleMiniappQr: 'Miniapp QR code', miniappQrTitle: 'Miniapp QR code',
      miniappQrHint: 'Scanning opens the Waven miniprogram with this channel\'s logo on the login screen; new users are assigned to the channel.',
      miniappQrDownload: 'Download PNG', miniappQrLoading: 'Generating…', miniappQrFailed: 'Failed to generate QR code',
      // ChannelModal
    ...
    partners: {
      countPartners: (n) => `${n} partner${n !== 1 ? 's' : ''}`, countCommissions: (n) => `${n} commission${n !== 1 ? 's' : ''}`,
    ...
    userDetail: {
      ...
      setPrimaryEmail: 'Set Primary',
      confirmSetPrimaryEmail: 'Set this email as primary?',
      confirmRemoveEmail: 'Remove this email?',
      emailRequired: 'Email address is required',
      emailInUse: 'This email is already attached to another account',
      emailInvalid: 'Invalid email address',
      addEmailUnverifiedNote: 'Added with no OTP proof — stays unverified unless this is the account’s only email. Email login is a Waven-channel feature; aeviva accounts stay phone-only.',
      profile: 'Profile',
      externalApp: 'External App',
  ...
  zh: {
    lab: {
      providers: '检验机构', mappings: '患者映射', reports: '检验报告',
      totalProviders: '机构总数', active: '启用', inactive: '停用', pollEnabled: '已开启轮询',
      countProviders: (n) => `共 ${n} 家机构`, addProvider: '添加机构',
      adapterKey: '适配器标识', label: '名称', apiBaseUrl: 'API 地址', poll: '轮询', lastPolled: '上次轮询',
      on: '开', off: '关', never: '从未', noProviders: '暂未配置检验机构',
      updateFailed: '更新失败', saveFailed: '保存失败', deleteFailed: '删除失败',
      confirmDeleteProvider: (name) => `确认删除机构「${name}」？`,
      addTitle: '添加检验机构', editTitle: (name) => `编辑 — ${name}`,
      apiKey: 'API Key', apiKeyKeep: 'API Key（留空则保持不变）',
      webhookSecret: 'Webhook 密钥', webhookSecretKeep: 'Webhook 密钥（留空则保持不变）',
      enablePolling: '开启轮询（每 4 小时定时拉取）',
      cancel: '取消', save: '保存', saving: '保存中…', edit: '编辑', del: '删除', close: '关闭',
      totalMappings: '映射总数', labsConnected: '已接入机构', usersLinked: '已关联用户',
      searchMappings: '搜索用户、机构、患者 ID…', countMappings: (n) => `共 ${n} 条映射`,
      linkPatient: '关联患者', user: '用户', lab: '机构', labPatientId: '机构患者 ID', linked: '关联时间',
      noMappings: '暂无映射，添加后即可接收检验结果。',
      confirmRemoveMapping: (id, name) => `确认移除映射 ${id} → ${name}？`,
      linkTitle: '关联机构患者 ID', nanoUser: 'Nano 用户', selectUser: '选择用户…', selectLab: '选择机构…',
      otherLab: '其他（在下方填写）', customLabPh: '适配器标识，如 kingmed', patientIdPh: '与机构系统中的编号一致', link: '关联',
      totalReports: '报告总数', parsed: '已解析', fromLabApi: '来自机构 API', manualUploads: '手动上传',
      allUsers: '全部用户', countReports: (n) => `共 ${n} 份报告`,
      date: '日期', source: '来源', institution: '机构', status: '状态', events: '指标数', created: '创建时间',
      noReports: '暂无报告', viewObservations: '查看指标', reportTitle: (id) => `报告 #${id}`,
      loadingReport: '报告加载中…', vitalSigns: '生命体征', diagnoses: '诊断 / 发现',
      clinicalSummary: '临床摘要', recommendations: '建议', followUp: '随访：',
      labObservations: '检验指标', biomarker: '指标', value: '数值', unit: '单位', dimension: '维度',
      noObservations: '该报告暂无关联指标。',
    },
    media: {
      title: '媒体资源', global: '全局', globalAll: '全局（所有渠道）', upload: '上传',
      uploadTitle: '上传媒体资源', noAssets: '暂无资源，上传一个开始使用。',
      confirmDelete: '确认删除此资源？', active: '启用', inactive: '停用',
      type: '类型', titleEn: '标题（英文）', titleZh: '标题（中文）', titleEnPh: 'Track title', titleZhPh: '中文标题',
      duration: '时长（秒）', durationPh: '例如 1800', sortOrder: '排序',
      channelHint: '渠道（留空为全局）', file: '文件', required: '类型、标题和文件为必填项',
      uploading: '上传中…', saving: '保存中…', done: '完成 ✓', cancel: '取消',
      types: { sleep_music: '助眠音乐', guide_video: '指导视频', document: '文档' },
      duration_fmt: (m, s) => `${m} 分 ${s} 秒`,
    },
    changelog: {
      title: '更新日志', loadFailed: '更新日志加载失败。', empty: '暂无更新日志。',
      sections: { 'New Features': '新功能', 'Improvements': '改进', 'Bug Fixes': '问题修复' },
    },
    brand: 'Nano 管理后台',
    nav: { dashboard: '数据概览', users: '用户管理', coaches: 'COACH', dots: '原粒', store: '商城管理', inventory: '库存管理', channels: '渠道管理', invites: '邀请码', kino: 'Kino 设备', chips: '芯片管理', boxes: '盒装管理', hardware: '硬件管理', rewards: '奖励管理', partners: '合伙人', finance: '财务管理', content: '内容管理', aiPersona: 'AI 人格', academy: '学院', tickets: '工单', adminAccounts: '管理员', questionnaires: '问卷管理', reports: '数据报表', healthPlans: '健康方案', coachCrm: 'CRM', lab: '检验中心', events: '线下活动', programs: '打卡计划', digitalAssets: '媒体资源', changelog: '更新日志', knowledge: '知识库', vivaSubscriptions: '订阅激活码' },
    adminAccounts: { title: '管理员账号', add: '添加管理员', changePassword: '修改密码', confirmDelete: '确认删除此管理员账号？', newPassword: '新密码', usernameLabel: '用户名', passwordLabel: '密码', count: (n) => `${n} 个账号`, subAccounts: '账号', subRoles: '角色', colEmailOtp: '邮箱验证码', colChannel: '渠道', colRole: '角色', channelAdmin: '渠道管理员', fullAccess: '全部权限（内置）', noRole: '未分配角色', allAccess: '全部', superadmin: '超级管理员', superadminAll: '超级管理员（所有渠道）' },
    ...
    stats: {
      ...
      aboveChrono: '高于实际', belowChrono: '低于实际', sameChrono: '与实际持平',
    ...
    modal: {
      ...
      deleteFailed: (detail) => `删除用户失败。${detail || '请重试。'}`,
    ...
    channels: {
      ...
      titleMiniappQr: '小程序码', miniappQrTitle: '小程序码',
      miniappQrHint: '扫码打开 Waven 小程序，登录页直接显示该渠道 Logo；新用户自动归入该渠道。',
      miniappQrDownload: '下载 PNG', miniappQrLoading: '生成中…', miniappQrFailed: '小程序码生成失败',
    ...
    partners: {
      countPartners: (n) => `共 ${n} 位合伙人`, countCommissions: (n) => `共 ${n} 条佣金记录`,
    ...
    userDetail: {
      ...
      secondaryEmail: '备用',
      unverifiedEmail: '未验证',
      setPrimaryEmail: '设为主邮箱',
      confirmSetPrimaryEmail: '将该邮箱设为主邮箱？',
      confirmRemoveEmail: '移除该邮箱？',
      emailRequired: '请输入邮箱地址',
      emailInUse: '该邮箱已绑定到其他账号',
      emailInvalid: '邮箱地址无效',
      addEmailUnverifiedNote: '未经验证码验证即添加，除非这是该账号唯一的邮箱，否则保持未验证状态。邮箱登录仅限 Waven 渠道，aeviva 账号仅支持手机号。',
      profile: '个人档案',
      externalApp: '外部应用',
      externalId: '外部 ID',
      height: '身高',
