const T = {
  ...
  zh: {
    brand: 'Nano 管理后台',
    nav: { dashboard: '数据概览', users: '用户管理', coaches: 'COACH', dots: '原粒', store: '商城管理', inventory: '库存管理', channels: '渠道管理', invites: '邀请码', kino: 'Kino 设备', chips: '芯片管理', hardware: '硬件管理', rewards: '奖励管理', partners: '合伙人', finance: '财务管理', content: '内容管理', aiPersona: 'AI 人格', academy: '学院', tickets: '工单', adminAccounts: '管理员', questionnaires: '问卷管理', reports: '数据报表', healthPlans: '健康方案', coachCrm: 'CRM', lab: '检验中心', events: '线下活动', digitalAssets: '媒体资源', changelog: '更新日志', knowledge: '知识库', vivaSubscriptions: '订阅激活码' },
