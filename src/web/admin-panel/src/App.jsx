...
// ── HTML description field (shared by store + inventory item modals) ─────────

// Preview-side guard: descriptions can be authored by channel admins, so strip
// anything executable before injecting into the superadmin's DOM.
...
// Fills a sparse [{day:'YYYY-MM-DD', ...}] series into a dense last-N-days array.
