...
INSERT INTO dots (id, key_name, name, name_zh, is_isolate, color, color_zh, color_hex, group_name, group_name_zh, sub_age_target, sub_age_target_zh, timing, coating, ingredients_summary, description, ingredients, ingredients_zh) VALUES

(1, 'DOT01', 'Cellular Fuel', '细胞原力', true, 'Deep Steel', '深钢蓝', '#4A5D7B', 'BioAge Reducing', '生物减龄', 'Cellular Age', '细胞年龄', 'Morning', 'enteric',
 'NMN / 烟酰胺单核苷酸',
 'The core NAD+ booster for cellular energy. [Enteric Coated for Intestinal Release]',
...
(2, 'DOT02', 'Cellular Guard', '细胞守护', true, 'Muted Amethyst', '柔紫', '#6B5B95', 'BioAge Reducing', '生物减龄', 'Cellular Age', '细胞年龄', 'Evening', 'gastric',
 'Apigenin / 芹菜素',
...
(3, 'DOT03', 'Cellular Catalyst', '细胞催化', true, 'Stormy Blue', '风暴蓝', '#5B7B8C', 'BioAge Reducing', '生物减龄', 'Cellular Age', '细胞年龄', 'Morning', 'gastric',
...
(4, 'DOT04', 'Cellular Cleanup', '细胞净化', false, 'Dusty Purple', '灰紫', '#7B6B8C', 'BioAge Reducing', '生物减龄', 'Cellular Age', '细胞年龄', 'Evening', 'gastric',
...
(5, 'DOT05', 'Metabolic Resilience', '代谢韧性', false, 'Slate Gray', '板岩灰', '#4E5E66', 'BioAge Reducing', '生物减龄', 'Metabolic Age', '代谢年龄', 'Morning', 'gastric',
...
(6, 'DOT06', 'Dermal Radiance (Collagen & Matrix)', '紧致焕颜', false, 'Mist Blue', '雾蓝', '#8A9AAB', 'BioAge Reducing', '生物减龄', 'Cellular Age', '细胞年龄', 'Evening', 'gastric',
 ...
 '[{"mg":6,"name":"高纯弹性胶原蛋白","mg_per_kg_male":0.25,"mg_per_kg_female":0.3,"max_mg_per_day":500,"contraindications":[]},{"mg":6,"name":"鲟鱼胶原蛋白肽","mg_per_kg_male":0.25,"mg_per_kg_female":0.3,"max_mg_per_day":2000,"contraindications":["鱼类过敏"]},{"mg":6,"name":"胶原三肽","mg_per_kg_male":0.25,"mg_per_kg_female":0.3,"max_mg_per_day":2000,"contraindications":[]},{"mg":6,"name":"N-乙酰神经氨酸","mg_per_kg_male":0.25,"requested_mg_per_kg_female":0.3,"max_mg_per_day":500,"contraindications":[]}]'),

(7, 'DOT07', 'Metabolic Power', '代谢动力', true, 'Muted Gold', '哑金', '#C9A66B', 'Energy & Performance Boost', '能量焕发', 'Metabolic Age', '代谢年龄', 'Morning', 'gastric',
 'PQQ / PQQ',
 'For mitochondrial biogenesis.',
 '[{"mg":24,"name":"PQQ","mg_per_kg_male":0.3,"mg_per_kg_female":0.3,"max_mg_per_day":40,"contraindications":[]}]',
 '[{"mg":24,"name":"PQQ","mg_per_kg_male":0.3,"mg_per_kg_female":0.3,"max_mg_per_day":40,"contraindications":[]}]'),

(8, 'DOT08', 'Vascular Awakening (Flow & Methylation)', '血管唤醒', false, 'Sage', '鼠尾草绿', '#8BA889', 'Energy & Performance Boost', '能量焕发', 'Micro-Vascular Age', '微血管年龄', 'Morning', 'gastric',
 'Beta-Alanine / β-丙氨酸, Niacin (Nicotinic Acid) / 烟酸, Methyl-B Complex / 甲基化复合B族',
 'Induces mild paresthesia (tingle) and niacin flush for physical feedback, while supporting methylation. [Rapid Gastric Release]',
...
(9, 'DOT09', 'Resilience Support', '抗压支持', true, 'Seafoam', '海泡绿', '#7FA99B', 'Energy & Performance Boost', '能量焕发', 'Resilience Age', '抗压年龄', 'Morning', 'gastric',
 'Curcumin / 姜黄素',
...
(10, 'DOT10', 'Morning Ignition (Energy & Focus)', '晨间引擎', false, 'Olive Gold', '橄榄金', '#B8A44F', 'Energy & Performance Boost', '能量焕发', 'Cellular Age', '细胞年龄', 'Morning', 'gastric',
 'Dynamine (Methylliberine) / 甲基解放素, TeaCrine (Theacrine) / 苦茶碱',
 'Jitter-free, rapid-onset cognitive energy, motivation, and focus peaking in 15 minutes. [Rapid Gastric Release]',
...
(11, 'DOT11', 'Athletic Peak (Endurance & ATP)', '巅峰体能', false, 'Burnt Orange', '焦橙色', '#B55A30', 'Energy & Performance Boost', '能量焕发', 'Metabolic Age', '代谢年龄', 'Morning', 'gastric',
...
(12, 'DOT12', 'Deep Sleep & Recovery', '深度睡眠与恢复', false, 'Midnight Blue', '午夜蓝', '#2C3E50', 'Energy & Performance Boost', '能量焕发', 'Resilience Age', '抗压年龄', 'Evening', 'gastric',
...
(13, 'DOT13', 'Vascular Flow', '微血管通流', false, 'Terracotta', '陶土红', '#D68C7A', 'System Optimization', '系统调优', 'Micro-Vascular Age', '微血管年龄', 'Morning', 'enteric',
 'CoQ10 / 辅酶Q10, Nattokinase / 纳豆激酶',
 'Potent cardiovascular clearing and mitochondrial energy support. [Enteric Coated for Intestinal Release]',
...
(14, 'DOT14', 'Vascular Protection', '微血管保护', false, 'Periwinkle', '长春花蓝', '#A8B5E0', 'System Optimization', '系统调优', 'Micro-Vascular Age', '微血管年龄', 'Morning', 'gastric',
...
(15, 'DOT15', 'Zen & Stress Resonance', '禅意与抗压共振', false, 'Muted Rose', '柔粉', '#D9AEB4', 'System Optimization', '系统调优', 'Resilience Age', '抗压年龄', 'Evening', 'gastric',
...
(16, 'DOT16', 'Resilience Defense', '抗压防御', false, 'Soft Sky', '柔空蓝', '#9BB7D4', 'System Optimization', '系统调优', 'Resilience Age', '抗压年龄', 'Evening', 'enteric',
 'Glutathione / 谷胱甘肽, NAC / N-乙酰-L-半胱胺酸, Milk Thistle / 水飞蓟, L-Ergothioneine / 麦角硫因',
 'Comprehensive defense against oxidative stress and support for liver detoxification. [Enteric Coated for Intestinal Release]',
...
(17, 'DOT17', 'Gut & Microbiome', '肠道屏障与微生态', false, 'Pebble', '鹅卵石灰', '#C2C5BB', 'System Optimization', '系统调优', 'Resilience Age', '抗压年龄', 'Evening', 'enteric',
 'L-Glutamine / L-谷氨酰胺, Akkermansia / AKK益生菌, Digestive Enzymes / 复合蛋白酶',
 'Gut Barrier & Microbiome [Enteric Coated for Intestinal Release]',
...
(18, 'DOT18', 'Immunity & Gastric', '免疫与胃部防御', false, 'Peach Clay', '桃泥色', '#E6BEA5', 'System Optimization', '系统调优', 'Resilience Age', '抗压年龄', 'Morning', 'gastric',
 'Liposomal Vit C / 脂质体维生素C, EGCG / EGCG, Zinc Glycinate / 甘氨酸锌, Zinc Carnosine / 肌肽锌',
 'Immunity & Gastric Defense [Gastric Release for Mucosal Support]',
...
-- Verify
SELECT id, key_name, name_zh, timing, coating, color_hex, group_name, sub_age_target FROM dots ORDER BY id;
