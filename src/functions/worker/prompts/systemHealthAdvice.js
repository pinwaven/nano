...
module.exports = (context) => {
  const {
    ...
    active_health_plans, plan_templates,
  } = context;
...
3. **健康状况关联** — 如用户有申报的健康问题，结合生物标志物数据进行说明${planTaskZhExtra}
...
3. **Health Conditions Connection** — If the user has declared health conditions, connect them to the biomarker findings${planTaskEnExtra}
