...
4. **下一步提问** — 结尾提问："您最想先从哪个方面开始改善？"并列出四个维度选项（${dimListZh}）。告知用户选择后，你会帮他们决定具体应该购买哪些 Dots 开始。
...
4. **Next Step Question** — End by asking: "Which area would you like to focus on and improve first?" and list the 4 dimensions as options (${dimListEn}). Tell them that once they choose, you'll help them decide exactly which Dots to start with.
