...
RESPOND WITH ONLY VALID JSON, NO OTHER TEXT:
{
  ...
  "tools_needed": ["<any of: get_biomarkers, get_biomarker_history, get_dots, get_health_plan, get_formulation_packages, get_food_sensitivity, get_health_reports, get_lab_history, get_questionnaire_responses, get_weight_history, get_health_twin, get_nutrition_schedule, get_reminders>"],
