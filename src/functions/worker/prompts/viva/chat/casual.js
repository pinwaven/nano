...
module.exports = withResponseLanguage(({ user_profile, questionnaire_context, active_health_plans, essential_knowledge, user_facts, now_iso, wearable_daily, wearable_insights, client }) => {
...
${getAppGuideBlock({ client, isZh: user_profile?.language !== 'en' })}
