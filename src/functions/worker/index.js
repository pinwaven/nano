...
exports.handler = async (req, resp, context) => {
    ...
    try {
        ...
        if (method === 'GET') {
            ...
            } else if (path.includes('/kino-curves')) {
                result = await handleGetKinoCurves(query);
