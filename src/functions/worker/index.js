...
async function handlePostKinoResult(body) {
    ...
    if (biomarkerId === null) {
        ...
        biomarkerId = bmResult.rows[0].id;
    }

    return { success: true, scan_id, biomarker_id: biomarkerId, user_id };
}
