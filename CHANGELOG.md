...
- **The health tab's text can be enlarged, by pinching it** (`app.wxss`, `components/user-health/user-health.{wxss,js,wxml}`, `pages/main/`, `pages/coach/`, `worker/handlers/users.js`)
