...
const T = {
  en: {
    brand: 'Nano Admin',
    nav: { users: 'Users', phms: 'PHM Coaches', dots: 'Precision Dots' },
    topbar: { refresh: 'Refresh', loading: 'Loading…' },
    updated: 'Updated',
    stats: {
      totalUsers: 'Total Users', tested: 'Tested', avgBioAge: 'Avg Bio Age',
      phmCoaches: 'PHM Coaches', totalCoaches: 'Total Coaches',
    ...
    table: {
      ...
      name: 'Name', email: 'Email', phone: 'Phone', customers: 'Customers',
      key: 'Key', nameEn: 'Name (EN)', nameZh: 'Name (ZH)', color: 'Color',
      type: 'Type', description: 'Description',
      unassigned: 'Unassigned',
    },
    empty: { users: 'No users found', phms: 'No PHM coaches found', dots: 'No dots found' },
    count: (n) => `${n} users`,
    addUser: 'Add User',
    addPhm: 'Add Coach', addDot: 'Add Dot',
    countPhm: (n) => `${n} coaches`,
    countDot: (n) => `${n} dots`,
    modal: {
      addUser: 'Add User', editUser: 'Edit User', deleteUser: 'Delete User',
      addPhm: 'Add Coach', editPhm: 'Edit Coach', deletePhm: 'Delete Coach',
      ...
      deletePhmWarning: (name) => `Delete coach ${name}? Their assigned users will become unassigned.`,
  ...
  zh: {
    brand: 'Nano 管理后台',
    nav: { users: '用户管理', phms: 'PHM 教练', dots: '精准营养点' },
    topbar: { refresh: '刷新', loading: '加载中…' },
    updated: '更新于',
    stats: {
      totalUsers: '总用户数', tested: '已检测', avgBioAge: '平均生物年龄',
      phmCoaches: 'PHM 教练数', totalCoaches: '教练总数',
    ...
    table: {
      ...
      assignedPhm: '负责教练', joined: '注册时间',
      name: '姓名', email: '邮箱', phone: '电话', customers: '客户数',
      key: '标识', nameEn: '名称 (英)', nameZh: '名称 (中)', color: '颜色',
      type: '类型', description: '描述',
      unassigned: '未分配',
    },
    empty: { users: '暂无用户', phms: '暂无 PHM 教练', dots: '暂无营养点' },
    count: (n) => `共 ${n} 位用户`,
    addUser: '添加用户',
    addPhm: '添加教练', addDot: '添加营养点',
    countPhm: (n) => `共 ${n} 位教练`,
    countDot: (n) => `共 ${n} 个营养点`,
    modal: {
      addUser: '添加用户', editUser: '编辑用户', deleteUser: '删除用户',
      addPhm: '添加教练', editPhm: '编辑教练', deletePhm: '删除教练',
      ...
      assignedPhm: '负责教练', unassigned: '未分配',
      ...
      deletePhmWarning: (name) => `确认删除教练 ${name}？其名下用户将变为未分配状态。`,
...
export default function App() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      setData({ users: uRes.data.customers || [], dots: dRes.data.dots || [], phms: pRes.data.phms || [] });
