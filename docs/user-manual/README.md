...
| Role | Panel | Guide |
|---|---|---|
| Any signed-in user | Main Mini Program | [End User Guide](end-user-guide.md) |
| `coach` | Coach Panel (in-app) | [Coach Guide](coach-guide.md) |
| `admin` | Channel Admin Panel (in-app) | [Admin Guide](admin-guide.md) |
| `superadmin` | Super Admin Panel (in-app) + Web Admin Panel | Not covered — see architecture docs |

A single account can hold multiple roles at once (for example, a coach who is also a channel admin) — the app's menu shows an entry for each role you hold.
