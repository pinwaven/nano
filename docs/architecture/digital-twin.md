...
| 2 | 日常监测 | Daily Monitoring | `health_events(sleep\|activity\|vitals\|body_composition\|ecg)`; `health_twin.avg_* / latest_weight_kg / latest_bmi / latest_body_fat_pct / trend_data / wearable_insights` ([wearable-insights.md](wearable-insights.md)) | `t.layerDaily` | `DIGITAL TWIN · DAILY MONITORING` |
...
| 2 | `日常监测` | `Daily Monitoring` | `health_events(sleep\|activity\|vitals\|body_composition\|ecg)`; `health_twin.avg_* / latest_weight_kg / latest_bmi / latest_body_fat_pct / trend_data` |
